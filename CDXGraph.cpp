...
//		if (mSeeking)
//		{
//			mSeeking->SetTimeFormat(&TIME_FORMAT_FRAME);
// 		}
		return SUCCEEDED(hr);
	}
	return false;
...
bool CDXGraph::GetFrameDuration(double *outDuration)
{
	HRESULT hr;
	if (mSeeking)
	{
...
bool CDXGraph::GetCurrentFramePosition(double *outPosition)
{
